/*
GAMA DE TENSAO NA ENTRADA ADC (0 - 3.3V) REPRESENTS TEMPERATURE 15 - 65
SPECS:
1. ADC - 2 CONVERSOES POR AMOSTRA
2. FREQ DA AMOSTRAGEM DA ADC - 10Hz - OBTIDA DO CORE TIMER
3. FIM DA CONVERSÃO DA ADC -> POLLING
4. FREQ DOS DISPLAYS DEVE SER 120Hz
5. REFRESH FEITO POR INTERRUPTCAO
